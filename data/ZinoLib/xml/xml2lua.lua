...
local XmlParser = Include(path.."XmlParser.lua")
_G["xml2lua"] = xml2lua
xml2lua.treepath = path .. "xmlhandler\\tree.lua"
xml2lua.dompath = path .. "xmlhandler\\dom.lua"
xml2lua.dom = Include(xml2lua.dompath)
...
--@see XmlParser
function xml2lua.parser(handler,stripWS)
